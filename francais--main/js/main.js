...
const EcoApp = {
    ...
    _buildExhibits() {
        ...
        try {
            if (window.MediaPlacement && typeof window.MediaPlacement.build === 'function') {
                window.MediaPlacement.build(this.scene);
                console.log('Media placement applied');
            }
        } catch (e) {
            console.warn('Media placement error:', e);
        }
    },
